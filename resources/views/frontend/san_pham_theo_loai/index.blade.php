     ...
     <!-- Start Rightside - Product Type View -->
            <div class="col-lg-9">
                ...
                <div class="sort-box m-tb-40">
                    ...
                    <form id="form_loc" method="get">
                        ...
                        <div class="sort-box__option">
                            <label class="select-sort__arrow">
                                <select name="select" class="select-sort">
                    ...
                    <div class="sort-box-item">
                        <span>Hiển thị 1-{{$count_page}} trong tổng số {{$count}}</span>
                    </div>
                                ...
                                <div class="col-12">
                                    <div class="product__box product__box--list">
                                        ...
                                        <div class="product__content">
                                            ...
                                            <a href="{{route('get.chi_tiet_san_pham',$item->id)}}" class="product__link"><h5 class="font--regular">{{$item->tendouong}}</h5></a>
                                            <div class="product__price m-t-5">
                                            ...
                                            <ul class="product__action--link-list m-t-30">
                                                <li><a href="{{route('get_ajax.shopping.add',$item->id)}}" class="js-add-cart" data-toggle="modal" class="btn--black btn--black-hover-green">Add to cart</a></li>
                                                <li><a href="compare.html"><i class="icon-sliders"></i></a></li>
                                                <li><a href="wishlist.html"><i class="icon-heart"></i></a></li>
                                            </ul> <!-- End Product Action Link -->
                                        </div> <!-- End Product Content -->
